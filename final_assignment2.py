...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4=dcc.Graph(
            ...
            x='unemployment rate',y='automobile sales',
            color='Vehicle_Type',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        x='year',y='sales',
        title="yearly sales for whole period"))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(monthly_sales,
        x='month',y='sales',
        title="total monthly sales in a year{}".format(input_year)
        ))
        ...
        title='total expenditure for each vehicle{}'.format(input_year)
        ))
